"""
Copy of the Objaverse script to be able to change cache loaction:
https://huggingface.co/datasets/allenai/objaverse/discussions/5
"""
...
BASE_PATH = os.path.join(os.environ["TMPDIR"], ".objaverse")
